...
static float vertex_colors[12] = {
    col(235), col(114), col(113), 1,
    col(229), col(155), col(95), 1,
    col(252), col(218), col(150), 1,
};
...
void init() {
    ...
    vertex_desc.attributes[1].offset = 0;
    vertex_desc.attributes[1].bufferIndex = 1;
    vertex_desc.layouts[0].stride = sizeof(float) * 3;
    vertex_desc.layouts[1].stride = sizeof(float) * 4;
